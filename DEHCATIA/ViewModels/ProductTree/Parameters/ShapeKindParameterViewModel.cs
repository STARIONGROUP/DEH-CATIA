// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ShapeKindParameterViewModel.cs" company="RHEA System S.A.">
...
namespace DEHCATIA.ViewModels.ProductTree.Parameters
{
    ...
    /// </summary>
    public class ShapeKindParameterViewModel : DstParameterViewModel<ShapeKind>
    {
        /// <summary>
        /// Initializes a new <see cref="DstParameterViewModel{TValueType}"/>
        /// </summary>
        /// <param name="value">The value</param>
        public ShapeKindParameterViewModel(ShapeKind value) : base(DoubleWithUnitValueParameterExtension.ShapeKindParameterName, value)
        {
        }
    }
}
